...
let backgroundButton = document.getElementById("backgroundClicker");
let elementToChange = document.querySelector("body");

backgroundButton.addEventListener("click", newColor);
...
const divToBeClicked = document.getElementById("karatClicker");

const numberToChange = document.getElementById("numOfChiChis");
function moreChihuahuas() {
  chihuahuaCount += 1;
  console.log(numberToChange.innerText);
  numberToChange.innerText = `${chihuahuaCount}`;
  // changeChiChi();
